...
print("Evan VanderHoeven")
# `problem 2. In the array.py
#  create an array named 'cars'
#  with the following elements 
# in this order  ---- Ford,Chrysler,
# Dodge,Ram,Jeep,Chevy,GMC` 
...
# with a value of the cars array length (spelling,
# capitilization, and spaces matter)`
my_array_length = len(cars)
# `problem 17. create a variable called array_string with
#  a value of 'The length of my array is ' (spelling,
#  capitilization, and spaces matter)`
...
print('==========================================')
element = 1
for car in cars: #len(cars)=8   # len of list (i=0, i<cars.len, i++)
    print(element, car)
